...
import { ApprovalPromptCard, MutationPreviewBlock } from '@/components/ApprovalPromptCard';
import {
...
// Named exports — re-used by ApprovalBatch to classify and render grouped approval requests.
export { isApprovalPrompt, getStructuredMutationPreview, getApprovalDecision, normalizeApprovalText, ApprovalPromptCard };
