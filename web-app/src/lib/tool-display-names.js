...
const TOOL_DISPLAY_MAP = {
    ...
    'edit_jira_comment': { label: 'Edit Jira Comment', category: 'jira', effect: 'write', impactLevel: 'high', requiresConfirmation: true },
    ...
    'log_jira_work': { label: 'Log Jira Work (Time Tracking)', category: 'jira', effect: 'write', impactLevel: 'high', requiresConfirmation: true },
    'update_jira_estimates': { label: 'Update Jira Estimates (Original/Remaining)', category: 'jira', effect: 'write', impactLevel: 'high', requiresConfirmation: true },
